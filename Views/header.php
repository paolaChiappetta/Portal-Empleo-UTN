...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo CSS_PATH ?>bootstrap-grid.css">
    <link rel="stylesheet" type="text/css" href="<?php echo CSS_PATH ?>bootstrap-reboot.css">
